...
DONE (see the DONE rows below) and adversarially hardened — **295 green tests**
(store 50 + graph 66 + facts 36 + consistency 22 + rag_query 36 [34 + 2
quick-pin `MultiQueryExpansionFailed` reachability] +
